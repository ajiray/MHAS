...
@section('content')
    ...
    <body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-4">
                <h1 class="text-2xl text-center">MindScape Video Call</h1>
            </div>


            <div class="max-w-2xl flex items-center justify-center">
                <div class="grid md:grid-cols-8 grid-cols-1 mt-4 items-center justify-center">
                    <div class="md:col-span-5">
                        <form method="post" action="{{ route('validateMeeting') }}">
                            {{ csrf_field() }}
                            <div class="mt-1 flex rounded-md shadow-sm items-center justify-center">
