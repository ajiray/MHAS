...
<body>
    <div class="w-full h-full flex flex-col justify-between">
        <div class="flex items-center justify-center p-1 w-full bg-maroon">
            <div style="width: 95px; height: 75px;">
                <img src="./images/logo.png" class="w-full h-full rounded-full" alt="Logo">
            </div>
            <div class="text-white font-bold text-2xl ml-2 mt-6">
                MindScape ChatBot
            </div>
        </div>

        <div id="content-box" class="flex-grow-1 p-1 overflow-y-scroll bg-slate-300 h-full text-white">
            <!-- Your content here -->
        </div>

        <div class="flex justify-center items-center p-2 bg-maroon h-11">
            <div class="pr-2 w-2/4 bg-white bg-opacity-28 rounded-2xl">
                <input id="input" class="text-black h-10 w-full bg-transparent border-0 outline-none pl-2"
