    ...
    <div class="container-fluid p-0 d-flex flex-column" style="min-height: 90vh; background:#5c211d;">
        ...
        <div class="d-flex p-2" style="background: #5c211d;">
            <div class="mr-2 flex-grow-1 pr-2" style="background: #ffffff1c; border-radius: 5px;">
                <input id="input" class="text-white w-100" type="text" name="input"
                    style="background: none; border: 0; outline: none;">
            </div>
            <div id="button-submit" class="d-flex align-items-center justify-content-center"
                style="background: #89201a; border-radius: 5px; width: 50px;">
